...
///
/// XML usage:
///   <AskOpenQuestion question="What is your name?" answer="{user_answer}"/>
class AskOpenQuestion : public BT::SyncActionNode
{
public:
  AskOpenQuestion(const std::string & name, const BT::NodeConfig & conf);
